...
func lfdRetType(lfd LetFuncDef) FType {
	switch _v332 := (lfd.fvar.ftype).(type) {
	case FType_FFunc:
		ft := _v332.Value
		return freturn(ft)
	default:
